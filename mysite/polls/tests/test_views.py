...
class TestQuestionIndexView():
    ...
    def test_past_question(self):
        ...
        index page.
        """
        question = QuestionFactory(question_text="Past question.", days=-30)
    ...
    def test_future_question(self):
        ...
        the index page.
        """
        QuestionFactory(question_text="Future question.", days=30)
        response = Client().get(reverse('polls:index'))
        assert "No polls are available." in response.content.decode()
        assert len(response.context['latest_question_list']) == 0
    ...
    def test_two_past_questions(self):
        ...
        """
        question1 = QuestionFactory(question_text="Past question 1.", days=-30)
        question2 = QuestionFactory(question_text="Past question 2.", days=-5)
