...
class TestQuestionIndexView():
    ...
    def test_past_question(self):
        ...
        index page.
        """
        question = QuestionFactory(question_text="Past question.", days=faker.random_int(min=-1000, max=-1))

        client = Client()
        response = client.get(reverse('polls:index'))
        assert question in response.context['latest_question_list'], "Past question exist on the index page"
    ...
    def test_two_past_questions(self):
        ...
        """
        question1 = QuestionFactory(question_text="Past question 1.", days=faker.random_int(min=-1000, max=-500))
        question2 = QuestionFactory(question_text="Past question 2.", days=faker.random_int(min=-499, max=-1))
